    ...
    sealed partial class App : Application
    {
        ...
        async protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (rootFrame == null)
            {
                ...
                rootFrame = new Frame();
                helpers.SuspensionManager.RegisterFrame(rootFrame, "appFrame");
                ...
                if (e.PreviousExecutionState == ApplicationExecutionState.Terminated)
                {
                    ...
                    await helpers.SuspensionManager.RestoreAsync();
                }
        ...
        async private void OnSuspending(object sender, SuspendingEventArgs e)
        {
            ...
            await KursyWalut.helpers.SuspensionManager.SaveAsync();
            deferral.Complete();
        }
    }
}
